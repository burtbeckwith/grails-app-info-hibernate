...
<g:render plugin='appInfoHibernate' template='/appinfo/hibernateCombos'/>
...
<table id="tableInfo" cellpadding="0" cellspacing="0" border="0" class="display">
	...
	<tbody>
		...
		<tr><td>Create SQL</td><td>${table.sqlCreateString(dialect, mapping, defaultCatalog, defaultSchema)}</td></tr>
...
<g:each var='column' in='${foreignKey.columnIterator}'>
			...
			<td><div style='overflow: auto; height: 100px; width: 200px;'>${foreignKey.sqlCreateString(dialect, mapping, defaultCatalog, defaultSchema)}</div></td>
...
<g:each var='column' in='${uniqueKey.columnIterator}'>
			...
			<td><div style='overflow: auto; height: 100px; width: 200px;'>${uniqueKey.sqlCreateString(dialect, mapping, defaultCatalog, defaultSchema)}</div></td>
...
<g:each var='column' in='${index.columnIterator}'>
			...
			<td><div style='overflow: auto; height: 100px; width: 200px;'>${index.sqlCreateString(dialect, mapping, defaultCatalog, defaultSchema)}</div></td>
